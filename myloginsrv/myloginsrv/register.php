<?php
// Datei: register.php – Stand: 2025-04-22 15:25 Europe/Berlin
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $email && $password) {
        try {
            ...
            file_put_contents("audit.log", date("c") . " Neue Registrierung von $username (inaktiv)
", FILE_APPEND);
            $info = "Dein Konto wurde angelegt. Nach Freigabe durch einen Administrator kannst du dich anmelden.";

    // Willkommensmail senden (nur wenn PHPMailer verfügbar)
