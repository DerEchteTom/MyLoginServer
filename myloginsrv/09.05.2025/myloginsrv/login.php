<?php
// Datei: login_combined.php – Kombinierter Login (lokal + AD) – Stand: 2025-05-09 Europe/Berlin
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['local_login'])) {
    $username = trim($_POST['local_user'] ?? '');
...
renderDebugBox($debug, false); // standardmäßig ausgeblendet
?>
