<?php
// Datei: admin_systemstatus.php – Stand: 2025-05-09 Europe/Berlin
session_start();
...
<div class="container mt-4">
    ...
    <ul class="list-group list-group-flush mb-4">
        ...
        <li class="list-group-item">Max. Upload-Größe: <?= ini_get('upload_max_filesize') ?></li>
        <li class="list-group-item">Max. Post-Größe: <?= ini_get('post_max_size') ?></li>
        <li class="list-group-item">Session-Speicherpfad: <?= session_save_path() ?></li>
    </ul>

    <a href="admin.php" class="btn btn-outline-primary">Zurück zum Adminbereich</a>
</div>
</body>
</html>
